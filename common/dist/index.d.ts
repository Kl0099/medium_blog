import z from "zod";
export declare const signupInputes: z.ZodObject<{
    email: z.ZodString;
...
export declare const loginInputes: z.ZodObject<{
    email: z.ZodString;
    password: z.ZodString;
}, "strip", z.ZodTypeAny, {
    email: string;
...
export declare const blogInputes: z.ZodObject<{
    title: z.ZodString;
    content: z.ZodString;
}, "strip", z.ZodTypeAny, {
    title: string;
...
export declare const updateBlogInputes: z.ZodObject<{
